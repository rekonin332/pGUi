...
class PythonTashSvc(win32serviceutil.ServiceFramework):
    _svc_name_ = "PythonTaskSvc"
    _svc_display_name_ = "Python Task Scheduling Service"
    _svc_description_ = "This is Python services tasks"
...
if __name__ == '__main__':
    win32serviceutil.HandleCommandLine(PythonTashSvc)
    
    
#=============================================================
#   python Task_Schedule_Svc.py install
#   python Task_Schedule_Svc.py remove