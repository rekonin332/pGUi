...
class Maze():
    def __init__(self):
        # dictionary to hold room_number, room_obj <key, values> pairs
        self._rooms = {}
        
    def AddRoom(self, room):
        # use roomNumber to lookup value to retrieve room object
...
class DoorNeedSpell(Door):    
    def __init__(self, r1, r2):
        super(DoorNeedSpell, self).__init__(r1, r2)
        self.spell = Spell()
    ...
    def find_maze_rooms(maze_obj):
        ...
        for room_number in range(5):
            try:
                ...
                room.Enter()
                #append the room to list
                maze_rooms.append(room)
                for idx in range(4):
                    side = room.GetSide(idx)
    #                 print(side.__class__)
                    ...
                    if 'Door' in side_str:
                        ...
                        other_room = door.OtherSidesFrom(room)
